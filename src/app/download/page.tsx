export default function Download() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[rgb(105,58,151)] to-[rgb(88,28,135)] text-white py-20">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Download Frec App</h1>
          <p className="text-xl text-purple-100 max-w-3xl mx-auto">
            Get the Frec app and start your journey today. Available on iOS and Android.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#" className="bg-[rgb(105,58,151)] text-white hover:bg-[rgb(88,28,135)] font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-center flex items-center justify-center space-x-2">
              ...
              <div className="bg-gray-100 rounded-2xl p-8 max-w-sm mx-auto">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  <div className="space-y-4">
                    ...
                    <div className="text-lg font-semibold text-[rgb(105,58,151)]">2 min away</div>
                    <div className="bg-[rgb(105,58,151)] text-white py-3 px-4 rounded-lg text-center font-semibold">
                      Track Ride
                    </div>
                  </div>
                </div>
