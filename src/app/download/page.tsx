          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#" className="bg-black text-white hover:bg-gray-800 font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-center flex items-center justify-center space-x-2">
              ...
              <div className="bg-gray-100 rounded-2xl p-8 max-w-sm mx-auto">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  <div className="space-y-4">
                    ...
                    <div className="text-lg font-semibold text-blue-600">2 min away</div>
                    <div className="bg-blue-600 text-white py-3 px-4 rounded-lg text-center font-semibold">
                      Track Ride
                    </div>
                  </div>
                </div>
