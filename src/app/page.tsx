        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover-lift animate-fade-in-up animate-delay-300">
              ...
              <h3 className="text-xl font-semibold mb-4 animate-fade-in-up animate-delay-400 text-black">Safe & Secure</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover-lift animate-fade-in-up animate-delay-400">
              ...
              <h3 className="text-xl font-semibold mb-4 animate-fade-in-up animate-delay-500 text-black">Fast & Reliable</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover-lift animate-fade-in-up animate-delay-500">
              ...
              <h3 className="text-xl font-semibold mb-4 animate-fade-in-up animate-delay-600 text-black">Affordable Pricing</h3>
