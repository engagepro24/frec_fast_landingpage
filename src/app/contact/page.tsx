    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-purple-600 to-purple-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in-up animate-delay-100">Contact Us</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8 animate-fade-in-right animate-delay-400">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 hover-lift animate-fade-in-up animate-delay-700">
                ...
                <div className="flex items-start space-x-4 hover-lift animate-fade-in-up animate-delay-800">
                  <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0 hover-scale">
                    <svg className="w-6 h-6 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start space-x-4 hover-lift animate-fade-in-up animate-delay-900">
                  <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0 hover-scale">
                    <svg className="w-6 h-6 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
