    ...
    <footer className="bg-[#10041F] text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4 animate-fade-in-left animate-delay-100 ">
            <div className="flex items-center space-x-2 hover-scale">
              <Link href="/" className="flex items-center space-x-2 hover-scale">
                <Image src={logo1} alt="Frecfast logo" width={60} height={60} />
        ...
        9.935 0 0024 4.59z" />
              ...
              {/* Instagram */}
              <a href="#" className="text-white hover:text-purple-500 transition-all duration-300 hover-scale" aria-label="Instagram">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        15.02V8.98L15.5 12l-5.75 3.02z" />
          ...
          <div className="space-y-4 animate-fade-in-right animate-delay-300">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 hover-lift">
                <span className="text-gray-300">Customer Terms - Bike Taxi</span>
              </div>
              <div className="flex items-center space-x-3 hover-lift">
          ...
          <div className="space-y-4 animate-fade-in-right animate-delay-300">
            ...
            <div className="relative w-full">
              <input type="email" placeholder="Email Address" className="w-full px-4 py-2 pr-12 rounded-lg border border-[#F6ED87] focus:outline-none focus:border-purple-500 bg-transparent text-white" />
              <button type="submit" className="absolute inset-y-0 right-0 flex items-center justify-center px-3 py-0.5 bg-purple-600 rounded-r-lg hover:bg-purple-700 transition" >
