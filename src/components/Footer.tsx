        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about" className="text-gray-300 hover:text-purple-500 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/download" className="text-gray-300 hover:text-purple-500 transition-colors">
                  Download App
                </Link>
              </li>
            </ul>
